            ...
            <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <form className="flex gap-2">
                            <input
                                ...
                                className="flex-1 px-4 py-2 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-purple-500 focus:ring-2 focus:ring-purple-500 focus:ring-opacity-20 transition-colors"
                            />
                            <motion.button
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
                    <p className="text-center text-gray-600 dark:text-gray-300">
                        © {currentYear} Umesh. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
